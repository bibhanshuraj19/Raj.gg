      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          ...
          <p className="font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I'm a 20 year old machine learning  engineer located in India"],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            <SocialIcon
              url="https://github.com/bibhanshuraj19"
            ...
            />
            <SocialIcon
              url="https://www.linkedin.com/in/bibhanshu-raj-64b547283/"
            ...
            />
            <SocialIcon
              url="https://www.youtube.com/@raj.notebook"
            ...
            />
            <SocialIcon
              url="https://www.instagram.com/bibhanshuraj19"
            ...
            />
            <SocialIcon
              url="https://x.com/bibhanshuraj19"
            ...
            />
            <SocialIcon
              url="https://discord.gg/26YyDqkCcg"
            ...
            />
            <SocialIcon
              url="mailto:bibhanshuraj19@gmail.com"
