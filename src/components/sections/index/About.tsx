...
export default function About() {
  let mlTech: Tech[] = [
    ...
    { title: "Transformers", icon: <img alt="" draggable={false} className="h-6" src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" />, link: "https://huggingface.co/docs/transformers/" },
    { title: "RAG", icon: <img alt="" draggable={false} className="h-6" src="https://upload.wikimedia.org/wikipedia/commons/2/2d/Tensorflow_logo.svg" />, link: "https://www.databricks.com/glossary/retrieval-augmented-generation-rag" },
