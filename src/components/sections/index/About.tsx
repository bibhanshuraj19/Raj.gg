      ...
      <section id='about' className="max-w-4xl w-full flex flex-col mx-auto">
        ...
        <ul className="grid grid-cols-2 gap-4 mt-4">
          <AboutCard
            ...
            description="I'm a machine learning engineer passionate about building machine learning models. My journey began with Python and evolved into deep learning, model optimization, and deploying ML APIs. I love solving real-world problems using data-driven approaches."
            direction="top"
            span={2}
            delay={0.1}
